...
var (
	ps = &smbios.Structure{
		...
		Formatted: []byte{0x1, 0x3, 0xb3, 0x2, 0xe4, 0x6, 0x3, 0x0, 0xff, 0xfb,
			0x8b, 0x0f, 0x3, 0x8d, 0x80, 0x25, 0xa0, 0xf, 0xfc, 0x8,
...
func TestParseProcessor35(t *testing.T) {
	bios, err := processor.ParseProcessor(ps35)
	if assert.NoError(t, err) {
		t.Log(bios)
	}
}
